...
<form method="post" style="padding-left: 580px">
    <table>
        <tr>
            ...
            <td><input type="text" id="product-name" name="name" style="width: 300px" value="<?php echo $product->name?>"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input style="width: 300px" type="text" id="product-price" name="price" value="<?php echo $product->price?>"></td>
        </tr>
        <tr>
            <td><label for="product-quantity">Số lượng: </label></td>
            <td><input style="width: 300px" type="text" id="product-quantity" name="quantity" value="<?php echo $product->quantity?>"></td>
        </tr>
        <tr>
            <td><label for="product-description">Mô tả: </label></td>
            <td><textarea style="width: 300px" id="product-description" name="description" cols="21" value="<?php echo $product->description?>"></textarea></td>
        </tr>
        <tr>
            <td></td>
            <td style="text-align: right">
                <button type="submit" class="btn btn-success">Cập nhật mặt hàng</button>
